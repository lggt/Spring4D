...
procedure TLifetimeInspector.ProcessModel(const kernel: IKernel;
...
procedure TMethodInspector.ProcessModel(const kernel: IKernel;
  const model: TComponentModel);
var
...
procedure TPropertyInspector.ProcessModel(const kernel: IKernel;
  const model: TComponentModel);
var
...
procedure TFieldInspector.ProcessModel(const kernel: IKernel;
  const model: TComponentModel);
var
...
procedure TInjectionTargetInspector.ProcessModel(const kernel: IKernel;
  const model: TComponentModel);
begin
...
procedure TInterfaceInspector.ProcessModel(const kernel: IKernel;
  const model: TComponentModel);
var
...
procedure TInterceptorInspector.ProcessModel(const kernel: IKernel;
  const model: TComponentModel);
var
...
procedure TAbstractMethodInspector.ProcessModel(const kernel: IKernel;
  const model: TComponentModel);
